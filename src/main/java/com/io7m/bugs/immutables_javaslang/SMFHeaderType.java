...
package com.io7m.bugs.immutables_javaslang;
...
public interface SMFHeaderType
{
  ...
  @Value.Parameter
  List<Integer> attributesInOrder();
  ...
  @Value.Parameter
  Map<Integer, Integer> attributesByName();
  ...
  default void checkPreconditions()
  {
    ...
    final Map<Integer, Integer> named = this.attributesByName();
    for (final Integer attribute : this.attributesInOrder()) {
      final Option<Integer> attribute_opt = named.get(attribute);
